...
def get_cipher():  # Указываем число первого поля
...
def get_passcode(n):
    passdict = {}  # Создаем словари с кодами и паролями
...
# Создаем переменные для дальнейших вычислений
n = get_cipher()
print('Шифр   :', n)
...
pairs = []
result = ''
# Вычисляем кратность, добавляем пары в список и формируем строки результата
for i in pairnum1:
    for j in pairnum2:
        pn1 = i
        pn2 = j
...
print('Для этого шифра ведите пароль', result, 'во вторую вставку')
